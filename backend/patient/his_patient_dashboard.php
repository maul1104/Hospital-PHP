                    ...
                    <center>
                        <div class="about-move">
                            ...
                            <div class="single-services">
                                ...
                                <img src="../admin/assets/images/alur/<?php echo $row->gambar_alur;?>" alt="" style="height: 113px; width: 130px;">
                                </a>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_patient_register_for_treatment.php?doc_id=<?php echo $row->doc_id;?>&&doc_number=<?php echo $row->doc_number;?>" class="btn btn-xs btn-primary"><i class="mdi mdi-eye"></i> Daftar</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>

                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h3 class="text-danger">Usia : <?php echo $row->mdr_pat_age;?> Tahun</h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Nomor Rujukan : <?php echo $row->mdr_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Penyakit : <?php echo $row->mdr_pat_ailment;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Tanggal : <?php echo date("d M Y", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
                                                    <h2 class="align-centre">Anamnesia dan Pemeriksaan</h2>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                        <?php echo $row->mdr_pat_inspect;?>
                                                    </p>
                                                    <hr>
                                                    <h2 class="align-centre">Resep Dokter</h2>
                                                    <hr>
                                                    <p class="text-muted mb-4">

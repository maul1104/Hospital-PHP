                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="his_patient_dashboard.php">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_patient_register_for_treatment.php">Daftar Berobat</a>
                                    </li>
                                    <li>
                                        <a href="his_patient_regist_history.php">Kelola Data Berobat</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_patient_manage_medical_record.php">Kelola Data Rekam Medis</a>
                                    </li>

                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="inputState" class="col-form-label">Transfer Polik</label>
                                                <select id="inputState" required="required" name="doc_dept" class="form-control">
                                                    <option value="">Choose</option>
                                                    <?php
                                                    // Ambil data polik dari tabel his_polik
                                                    $ret = "SELECT * FROM his_polik";
                                                    $stmt = $mysqli->prepare($ret);
                                                    $stmt->execute();
                                                    $res = $stmt->get_result();
                                                    while ($polik = $res->fetch_object()) {
                                                        // Tampilkan setiap polik di dropdown
                                                        echo "<option value='" . $polik->nama_polik . "'>" . $polik->nama_polik . "</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>                                         

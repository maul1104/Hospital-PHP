                                ...
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <?php
                                                // Menghitung jumlah pasien yang dikirim ke dokter spesifik
                                                $result ="SELECT count(*) FROM pat_treatment WHERE doc_id = ? AND status_polik = 'Dikirim ke Dokter'";
                                            ...
                                            ?>
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Pasien</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-right">
                                                    ...
                                                    <p class="text-muted mb-1 text-truncate">Profil Saya</p>
                                                </div>
                                            </div>
                                        </div> <!-- end row-->
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM his_patient  ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                                    $stmt->bind_result($patient);
                                                    $stmt->fetch();
                            ...
                            <div class="col-xl-12">
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM pat_treatment WHERE doc_id = ? AND status_polik = 'Dikirim ke Dokter'";
